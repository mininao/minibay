...
CREATE TABLE MOUVEMENT(
	...
	pseudo          VARCHAR2 (25) NOT NULL  ,
	pseudo_USER     VARCHAR2 (25) NOT NULL  ,
...
ALTER TABLE AUCTION ADD FOREIGN KEY (seller_pseudo) REFERENCES USER(pseudo);
ALTER TABLE BID ADD FOREIGN KEY (ID_AUCTION) REFERENCES AUCTION(ID);
ALTER TABLE BID ADD FOREIGN KEY (bidder_pseudo) REFERENCES USER(pseudo);
ALTER TABLE MOUVEMENT ADD FOREIGN KEY (pseudo) REFERENCES USER(pseudo);
ALTER TABLE MOUVEMENT ADD FOREIGN KEY (pseudo_USER) REFERENCES USER(pseudo);
